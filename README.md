...
## Demo
![Captura de pantalla del sitio](file:///C:/Users/ybossio/.gemini/antigravity-ide/brain/0a25133b-b60c-4f4e-96a0-51fd7837e5ad/screenshot_placeholder_1781456976955.png)

> *El sitio está desplegado en Netlify.*\
> Visítalo: https://your-site.netlify.app
...
pnpm run dev
```
La aplicación estará disponible en `http://localhost:4322` (o el puerto que indique la consola).
